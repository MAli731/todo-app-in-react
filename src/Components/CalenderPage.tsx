...
// 1. Simple Helper: Date ko "YYYY-MM-DD" mein convert karne ke liye
...
export default function CalendarPage({ todos, Status }: { todos: any[]; Status: (id: number) => void }) {
    ...
    // 2. Filter: Jo date calendar pe click hui, uske todos nikalen
                            ...
                            <div className="modal-body">
                                {selectedTodo ? (
                                    ...
                                    <div>
                                        ...
                                        <p>Date: <strong>{selectedTodo.date}</strong></p>
                                        <p>Status: <strong>{selectedTodo.status}</strong></p>
                                        <button className="btn btn-secondary w-100" onClick={() => setSelectedTodo(null)}>Back to List</button>
                                    </div>
                                ) : (
                                    // List View
